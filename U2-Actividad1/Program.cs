namespace U2_Actividad1_Fanny_Lopez
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1 y 2 Validamos la cantidad de personas
            while (!entradaValida)
            {
            ...
            // 3 y 4 Captura de datos con validación de edad
            ...
            // En el caso especial: Una sola persona
            ...
            {
                // Mostramos la lista general primero
                ...
                // Mostramos sólo si contienen datos
                if (mayores.Count > 0)
                {
